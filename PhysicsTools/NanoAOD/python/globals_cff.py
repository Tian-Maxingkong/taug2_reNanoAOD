...
beamSpotTable = simpleBeamspotFlatTableProducer.clone(
    ...
    variables = cms.PSet(
       ...
       dxdz = Var("dxdz()", float, doc="BeamSpot slope, x position vs z (dx/dz, dimensionless)", precision=-1),
       dydz = Var("dydz()", float, doc="BeamSpot slope, y position vs z (dy/dz, dimensionless)", precision=-1),
